...
export const {
  changePage, toggleSectionsSelected, resetState, addDegree, addDegreeOption, addMajor, addSections, addCourseToSemester, removeCourseFromSections,
  reduceDegreeUnits, addCourseBackToSection, removeCourseFromYears, setElective, addYear, removeYear
} = userSlice.actions
